...
const EMAIL_FROM = 'emese@groenk.com'; // CHANGED 2026-09-14: groenk.com domain now verified in Resend — switched from the onboarding@resend.dev sandbox sender (which could only send to the single account-registration address) to a real @groenk.com sender, so this can now actually reach controlling@groenk.com.
